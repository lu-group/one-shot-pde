...
def pre_trained_NN(data, layers):
    ...
    losshistory, train_state = model.train(epochs=150000,callbacks=[checker], model_save_path = "model/model.ckpt")
...
def main():
    M = 1001
    # For other resolutions, just change  Nx, Nt, N_f
    Nx, Nt = 101, 101
    N_f = 101*101
    N_b = 0
    std = 0.10  # std for delta f
    std_num = "0.10"
    gen = True  # generate new data or not
    num = 100
    errs = []
